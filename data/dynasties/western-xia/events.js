...
(() => {
  const learningCases = {
    "xia-dangxiang-rise": { label: "党项如何在宋辽之间形成国家基础", claim: "党项拓跋部的崛起依靠夏州、河套与西北交通的地方资源，并在宋、辽竞争中灵活调整臣属和自主空间。西夏不是突然建国，而是边地军事集团长期国家化的结果。", sections: [["地理资源", "夏州与河套连接农牧区域和西北通道，能提供骑兵、贸易与防御空间。"], ["政治策略", "李继迁、李德明在宋辽间周旋，以名义关系换取时间与资源。"], ["国家化", "当部落军力、地方税源和王族继承被整合，李元昊称帝才成为可能。"]], evidence: { title: "材料锚点：《宋史·夏国传》与西夏碑刻、文书", content: "中原正史常以叛服叙述党项，需结合西夏文字材料理解其内部国家建设。" }, misconception: "西夏不是宋朝边患自然长成的国家，而有自身的边地资源和政治路径。", memory: ["夏州河套", "宋辽间周旋", "长期国家化"], question: "李元昊建国为何有长期前史？", answer: "党项已积累军事、地方资源与王族权威，建国是这些条件整合后的结果。" },
    "xia-yuanhao-proclaims-emperor": { label: "李元昊称帝为何引发全面冲突", claim: "称帝不仅改变国号，也挑战宋对西北的册封秩序。元昊借文字、服制和官制塑造独立王朝，同时必须证明新国家能承受与宋的长期战争。", sections: [["政治宣示", "帝号与改制将党项首领升级为与宋辽并列的统治者。"], ["国家建设", "西夏文字、官制和军政组织服务于内部整合，而不是文化装饰。"], ["外部压力", "宋无法轻易承认其对等地位，冲突遂从边地摩擦升为国家间战争。"]], evidence: { title: "材料锚点：西夏文字、官印与《宋史·夏国传》", content: "实物材料能补正宋方叙事，观察西夏如何公开建构王朝身份。" }, misconception: "元昊称帝不是单纯虚荣，它是国家主权与内部整合的公开声明。", memory: ["改制称帝", "文字官制", "挑战册封"], question: "西夏为何需要建立自己的文字与制度？", answer: "它们帮助把多元部众组织为可继承、可征发的独立王朝。" },
    "xia-song-war-sanzhuankou": { label: "宋夏战争为何让宋军屡受挫", claim: "三川口等战役显示，西北战争受地形、补给、骑兵机动和堡寨网络制约。宋军兵力与财政并不必然转为优势，远征进入西夏纵深时反而容易被切断与包围。", sections: [["战场条件", "高原、河谷和荒漠拉长补给线，骑兵可避开正面强攻并袭扰运输。"], ["宋的限制", "中央军指挥复杂、边将协同不足，难以在陌生地形持续追击。"], ["结果", "宋转向堡寨、守备与和议，西夏获得以较小资源维持独立的空间。"]], evidence: { title: "材料锚点：《续资治通鉴长编》与西北堡寨遗存", content: "将战役、补给与城寨分布结合，避免把失利只归为将领能力。" }, misconception: "宋夏战争不是单纯“宋弱夏强”，双方所处地理与动员方式不同。", memory: ["地形拉补给", "骑兵机动", "堡寨守备"], question: "宋为何难以凭财力迅速征服西夏？", answer: "西北远征的补给与地形成本会削弱财力和兵力优势。" },
    "xia-qingli-peace": { label: "庆历和议如何让西夏得以存续", claim: "庆历和议以岁赐和名义安排换取边境稳定，宋避免继续高成本西北战争，西夏获得可预期资源与实际自主。它不是谁彻底屈服，而是双方都承认无法低成本消灭对方。", sections: [["为何议和", "连年战事证明宋难深入、西夏也难长期威胁宋朝腹地。"], ["条款的含义", "岁赐与名义关系为双方保留体面，却让边境交易和休养成为常态。"], ["长期影响", "西夏可继续发展制度与文化，宋的西北财政压力则转入常态治理。"]], evidence: { title: "材料锚点：《宋史》《续资治通鉴长编》庆历和议条目", content: "比较战争成本、条款与后续边境秩序，避免只以名分判断协议。" }, misconception: "岁赐不自动证明宋失败，它也反映在特定战略条件下控制战争成本的选择。", memory: ["战无速胜", "岁赐换稳", "西夏存续"], question: "庆历和议为何能维持一段时间？", answer: "双方都从降低西北战争成本中受益，且难以通过军事彻底解决对方。" },
    "xia-renzong-prosperity": { label: "西夏盛期如何建立制度与文化", claim: "仁宗时期的稳定说明西夏不只是战争机器。文字、佛教、法律、翻译与地方治理共同支撑王朝，使其能在宋金辽多边格局中维持长期政治与文化生命。", sections: [["政治稳定", "较长期的统治降低继承和内战风险，官僚与地方秩序得以持续。"], ["文化制度", "西夏文字与佛教经典翻译服务行政、教育和王朝认同，也留下丰富文献遗产。"], ["外部平衡", "在金与宋之间调整外交，让有限资源不被单一边战耗尽。"]], evidence: { title: "材料锚点：黑水城文献、西夏佛经与《宋史·夏国传》", content: "黑水城出土文献使我们可从西夏自身文本观察行政与文化，不能只依宋方记载。" }, misconception: "西夏历史不能只由宋夏战争定义，制度与文化才解释其为何能长期存在。", memory: ["稳定统治", "黑水城文献", "多边平衡"], question: "为何黑水城文献对理解西夏特别重要？", answer: "它提供西夏自身的语言与行政文化材料，补足中原正史的外部视角。" },
