window.EUROPE_HISTORY_PACKAGE = {
  ...
  moduleIds: ["ancient-greece", "roman-republic", "roman-empire", "byzantium", "medieval-western-europe", "viking-nordic-europe", "iberia-reconquista", "eastern-europe-slavic", "russia", "renaissance-reformation", "early-modern-europe"],
  topicIds: [],
  boundaries: [
    "欧洲包先作为区域容器存在，不把未整理的欧洲事件混入当前中国时间线。",
    "后续欧洲史应优先按阶段模块扩展，再按国家专题细化，避免一开始按现代国家碎片化。",
    "古典地中海与西亚、北非有大量交叉，后续需要通过跨区域专题连接，不宜只按现代欧洲边界理解。",
    "俄罗斯可与“东欧、斯拉夫与罗斯世界”强关联：罗斯共享遗产、东斯拉夫文化和波兰立陶宛关系放在东欧斯拉夫模块，莫斯科-俄国国家形成、俄罗斯帝国和苏联国家结构放在俄罗斯模块。",
  ...
  nextExpansionSlots: [
    ...
    { id: "russia", title: "俄罗斯区域", status: "active", suggestedMinEvents: 45 },
