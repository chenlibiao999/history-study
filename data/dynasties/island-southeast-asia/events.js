(() => {
  ...
  const timeline = [["srivijaya","室利佛逝海峡网络","海峡佛教网络","7-13世纪","室利佛逝依托马六甲和巽他海峡，发展佛教、贡赋和海上贸易网络。"],["sailendra","夏连特拉与婆罗浮屠","爪哇王权","8-9世纪","爪哇中部佛教王权和婆罗浮屠显示岛屿东南亚与印度洋佛教世界的联系。"],["east-java","东爪哇政权延续","爪哇王权","10-13世纪","中爪哇重心转向东爪哇后，农业、港口和王权结构继续演化。"],["majapahit","满者伯夷","爪哇王权","13-15世纪","满者伯夷以爪哇为中心，通过贡赋、贸易和军事影响周边群岛。"],["islamization","港口伊斯兰化","伊斯兰港口","13-16世纪","穆斯林商人、苏丹国和海上贸易推动岛屿东南亚多地伊斯兰化。"],["malacca","马六甲苏丹国","伊斯兰港口","15世纪","马六甲成为连接印度洋、南海和群岛世界的伊斯兰港口枢纽。"],["portuguese-malacca","葡萄牙占领马六甲","伊斯兰港口","1511","葡萄牙进入马六甲标志欧洲海权直接介入东南亚海峡贸易。"]].map(event);
  const narratives = {
    "island-southeast-asia-srivijaya": "室利佛逝的影响来自海峡节点、港口联盟与佛教学习网络；“控制海峡”更应理解为对航路与交换关系的影响，不是近代式连续领土主权。",
    "island-southeast-asia-sailendra": "婆罗浮屠及其铭文显示中爪哇王权、佛教赞助和印度洋文化联系；王朝名称与政治边界仍有材料解释问题。",
    "island-southeast-asia-east-java": "爪哇政治重心东移与火山平原农业、港口贸易和区域竞争有关，说明岛屿国家的中心会随生态与航路重组。",
    "island-southeast-asia-majapahit": "满者伯夷通过爪哇核心区、港口和贡纳关系扩展影响；《爪哇史颂》中的理想版图不能直接等同实际行政控制。",
    "island-southeast-asia-islamization": "伊斯兰化主要沿港口、婚姻、苏丹国和商人网络推进，过程跨越数百年；不同岛屿与内陆社群的接受路径并不相同。",
    "island-southeast-asia-malacca": "马六甲把季风航行、转口贸易、伊斯兰法庭与多语商人社群汇集于海峡节点，成为连接印度洋与南海的中介市场。",
    "island-southeast-asia-portuguese-malacca": "1511年后葡萄牙占港并未垄断全部贸易，商人和苏丹国转向柔佛、亚齐等港口；欧洲介入首先改变的是航线竞争与武装港口秩序。"
  };
  window.ISLAND_SOUTHEAST_ASIA_EVENTS = timeline.map((item, index) => ({ ...item, contentLevel: "mainline", contentPresentation: "tiered", mainlineNarrative: narratives[item.id], background: [], process: [], results: [], debates: [], reviewQuestions: [], previousEventIds: index ? [timeline[index - 1].id] : [], nextEventIds: index < timeline.length - 1 ? [timeline[index + 1].id] : [] }));
})();
