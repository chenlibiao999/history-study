(() => {
  ...
  window.NORTHERN_SONG_EVENTS = [
    ...
    event({
      ...
      process: [
        { time: "979", title: "围攻太原", description: "宋太宗集中力量进攻北汉，太原坚固且有辽的外援压力。宋军最终攻下太原，北汉主刘继元投降。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。" },
    ...
    event({
      ...
      "summary": "范仲淹等推动庆历新政，试图整顿吏治和边防，但因阻力过大很快失败。",
      "people": [
            "范仲淹",
            "宋仁宗",
            "欧阳修"
      ...
      "background": [
            "范仲淹等推动庆历新政，试图整顿吏治和边防，但因阻力过大很快失败。"
      ],
      "process": [
            {
                  "time": "西北压力",
                  "title": "改革背景",
                  "description": "宋夏战争和冗官冗兵问题暴露财政压力，仁宗朝士大夫开始讨论系统性整顿。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            },
            {
                  "time": "新政推行",
                  "title": "整顿吏治",
                  "description": "范仲淹提出明黜陟、抑侥幸等措施，核心是提高官僚选任和行政效率。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            },
            {
                  "time": "反对加剧",
                  "title": "改革夭折",
                  "description": "新政触动既得利益，又缺少长期政治联盟，很快被罢止，为王安石变法提供前车之鉴。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            }
      ],
      "results": [
            "北宋改革意识提前出现。",
      ...
      "tip": "它连接仁宗盛世表象和神宗变法前因。",
      "claim": "范仲淹等推动庆历新政，试图整顿吏治和边防，但因阻力过大很快失败。",
      "plainText": "白话理解：范仲淹等推动庆历新政，试图整顿吏治和边防，但因阻力过大很快失败。这条线要放在北宋的连续主线中看，而不是只记一个孤立年份。",
      "question": "庆历新政与士大夫改革尝试为什么重要？",
      "answer": "它连接仁宗盛世表象和神宗变法前因。",
      "reference": "《宋史》《续资治通鉴长编》北宋相关纪事"
}),
    event({
      "id": "nsong-xining-wang-anshi-fiscal-state",
      "title": "熙宁变法的财政国家取向",
      "aliases": [],
      "era": "神宗变法",
      "time": "1069-1085",
      ...
      "summary": "王安石变法以青苗、免役、方田均税、保甲等措施提高财政和基层动员能力。",
      "people": [
            "王安石",
            "宋神宗"
      ],
      "background": [
            "王安石变法以青苗、免役、方田均税、保甲等措施提高财政和基层动员能力。"
      ],
      "process": [
            {
                  "time": "神宗即位",
                  "title": "求变压力",
                  "description": "冗兵冗官和边防军费让北宋财政紧张，神宗希望通过制度改革增强国家能力。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            },
            {
                  "time": "新法推行",
                  "title": "财政动员",
                  "description": "青苗、免役、方田均税等政策试图让国家更直接掌握税役和信贷资源，减少地方豪强中间盘剥。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            },
            {
                  "time": "争议扩大",
                  "title": "党争化",
                  "description": "新法执行引发扰民、利益冲突和理念分歧，改革逐渐与新旧党争绑定，政策连续性受损。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
            }
      ],
      "results": [
            "北宋财政军政改革达到高峰。",
      ...
      "tip": "它是理解北宋中后期政治的核心。",
      "claim": "王安石变法以青苗、免役、方田均税、保甲等措施提高财政和基层动员能力。",
      "plainText": "白话理解：王安石变法以青苗、免役、方田均税、保甲等措施提高财政和基层动员能力。这条线要放在北宋的连续主线中看，而不是只记一个孤立年份。",
      "question": "熙宁变法的财政国家取向为什么重要？",
      "answer": "它是理解北宋中后期政治的核心。",
      "reference": "《宋史》《续资治通鉴长编》北宋相关纪事"
})
  ];
})();

window.NORTHERN_SONG_EVENTS = window.NORTHERN_SONG_EVENTS || [];
window.NORTHERN_SONG_EVENTS.push(...[
  {
    "id": "northern-song-taizong-centralization",
    ...
    "summary": "宋太宗继位后继续收束武将权力、强化文官和中央财政，使北宋集权体制进一步定型。",
    "bookmarked": false,
    "people": [
      {
        "name": "宋太宗",
        ...
        "bio": "宋太宗需要放在“太宗朝文武权力再平衡”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "太宗朝文武权力再平衡"
        ]
      }
    ...
    "relations": [],
    "background": [
      "太宗朝文武权力再平衡发生前，北宋的政治结构、财政动员、地方秩序或边疆关系已经积累压力；这一事件能解释前后阶段为何发生转向。"
    ],
    "process": [
      {
        "time": "976-997",
        "title": "继位需要巩固合法性",
        "description": "太宗继位伴随烛影斧声等后世争议，政治上必须通过控制禁军、任用文臣和延续统一战争来巩固权威。"
      },
      {
        "time": "976-997",
        "title": "文官政治继续强化",
        "description": "太宗朝扩大科举和文臣任用，压低地方武将独立性。这样能防止唐末五代军阀重现，但也造成军事决策层级复杂。"
      },
      {
        "time": "976-997",
        "title": "制度定型影响北宋全局",
        "description": "中央集权和文官政治成为北宋优势，也是军事迟缓和财政膨胀的背景。理解北宋不能只看文化繁荣，要看制度选择。"
      }
    ],
    "results": [
      "宋太宗继位后继续收束武将权力、强化文官和中央财政，使北宋集权体制进一步定型。",
      "宋太宗继位后继续收束武将权力、强化文官和中央财政，使北宋集权体制进一步定型。"
    ],
    "debates": [
      {
    ...
    "claims": [
      {
        "statement": "宋太宗继位后继续收束武将权力、强化文官和中央财政，使北宋集权体制进一步定型。",
        "status": "较稳妥",
        "statusType": "stable",
        "confidence": "medium",
        "sourceIds": [
          "northern-song-round-source"
        ],
    ...
    "citations": [
      {
        "sourceId": "northern-song-round-source",
        "reference": "正史、编年史及现代通史相关纪事",
        "status": "已给公开入口，待逐条细核卷章",
        "plainText": "白话理解：宋太宗继位后继续收束武将权力、强化文官和中央财政，使北宋集权体制进一步定型。",
  ...
  {
    "id": "northern-song-qingli-reform",
    "dynastyId": "northern-song",
    "dynasty": "北宋",
    "title": "庆历新政与士大夫改革意识",
    "aliases": [],
    ...
    "summary": "范仲淹等推动庆历新政，试图整顿吏治、学校和边防，虽很快受阻，却开启北宋士大夫改革政治的重要阶段。",
    "bookmarked": false,
    "people": [
      {
        "name": "范仲淹",
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "范仲淹需要放在“庆历新政与士大夫改革意识”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "庆历新政与士大夫改革意识"
        ]
      },
      {
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "宋仁宗需要放在“庆历新政与士大夫改革意识”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "庆历新政与士大夫改革意识"
        ]
      }
    ...
    "relations": [],
    "background": [
      "庆历新政与士大夫改革意识发生前，北宋的政治结构、财政动员、地方秩序或边疆关系已经积累压力；这一事件能解释前后阶段为何发生转向。"
    ],
    "process": [
      {
        "time": "1043-1045",
        "title": "仁宗朝问题逐渐显现",
        "description": "冗官、冗兵、财政压力和西夏边患使北宋盛世内部出现治理焦虑。士大夫开始讨论如何通过制度改革恢复效率。"
      },
      {
        "time": "1043-1045",
        "title": "新政触动官僚利益",
        "description": "范仲淹提出明黜陟、抑侥幸、精贡举等措施，核心是提高官僚质量和行政责任。改革触及既得利益，遭到保守力量反弹。"
      },
      {
        "time": "1043-1045",
        "title": "为王安石变法提供前史",
        "description": "庆历新政失败说明温和整顿也会遇到政治阻力。后来王安石变法更激烈，正是在这一改革传统和焦虑中出现。"
      }
    ],
    "results": [
      "范仲淹等推动庆历新政，试图整顿吏治、学校和边防，虽很快受阻，却开启北宋士大夫改革政治的重要阶段。",
      "范仲淹等推动庆历新政，试图整顿吏治、学校和边防，虽很快受阻，却开启北宋士大夫改革政治的重要阶段。"
    ],
    "debates": [
      {
    ...
    "claims": [
      {
        "statement": "范仲淹等推动庆历新政，试图整顿吏治、学校和边防，虽很快受阻，却开启北宋士大夫改革政治的重要阶段。",
        "status": "较稳妥",
        "statusType": "stable",
        "confidence": "medium",
        "sourceIds": [
    ...
    "citations": [
      {
        ...
        "reference": "正史、编年史及现代通史相关纪事",
        "status": "已给公开入口，待逐条细核卷章",
        "plainText": "白话理解：范仲淹等推动庆历新政，试图整顿吏治、学校和边防，虽很快受阻，却开启北宋士大夫改革政治的重要阶段。",
        "note": "不堆原文，先给学习者能读懂的解释；涉及争议细节时以主流史学概括为准。"
      }
    ],
    "causalChain": [],
    ...
    "reviewQuestions": [
      {
        "type": "主线理解",
        "question": "庆历新政与士大夫改革意识为什么应进入北宋主线？",
        "answer": "因为它改变了权力结构、制度运行、战争格局或社会经济秩序，能解释前后阶段如何衔接。"
      }
    ],
    "notes": [],
  ...
  {
    "id": "northern-song-xihe-expansion",
    "dynastyId": "northern-song",
    "dynasty": "北宋",
    "title": "熙河开边与西北战略调整",
    "aliases": [],
    ...
    "summary": "北宋在熙河方向经营吐蕃诸部，试图绕击西夏、拓展西北战略空间，是王安石变法时期军事财政结合的代表。",
    "bookmarked": false,
    "people": [
      {
        "name": "王韶",
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "王韶需要放在“熙河开边与西北战略调整”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "熙河开边与西北战略调整"
        ]
      },
      {
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "宋神宗需要放在“熙河开边与西北战略调整”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "熙河开边与西北战略调整"
        ]
      }
    ...
    "relations": [],
    "background": [
      "熙河开边与西北战略调整发生前，北宋的政治结构、财政动员、地方秩序或边疆关系已经积累压力；这一事件能解释前后阶段为何发生转向。"
    ],
    "process": [
      {
        "time": "1072-1074",
        "title": "宋夏僵局推动新战略",
        "description": "北宋正面攻夏代价高昂，朝廷希望从熙河、陇右方向打开侧翼。王韶提出经营吐蕃部族，以改变西北格局。"
      },
      {
        "time": "1072-1074",
        "title": "军事推进依赖财政改革",
        "description": "熙河开边需要军费、粮运、堡寨和地方安抚，与青苗、免役等变法财政能力相互关联。它不是单纯边将冒进。"
      },
      {
        "time": "1072-1074",
        "title": "战略收益与负担并存",
        "description": "北宋取得部分地区和战略支点，但长期守边成本上升。熙河开边显示北宋有主动战略，也暴露财政军制压力。"
      }
    ],
    "results": [
      "北宋在熙河方向经营吐蕃诸部，试图绕击西夏、拓展西北战略空间，是王安石变法时期军事财政结合的代表。",
      "北宋在熙河方向经营吐蕃诸部，试图绕击西夏、拓展西北战略空间，是王安石变法时期军事财政结合的代表。"
    ],
    "debates": [
      {
    ...
    "claims": [
      {
        "statement": "北宋在熙河方向经营吐蕃诸部，试图绕击西夏、拓展西北战略空间，是王安石变法时期军事财政结合的代表。",
        "status": "较稳妥",
        "statusType": "stable",
        "confidence": "medium",
        "sourceIds": [
    ...
    "citations": [
      {
        ...
        "reference": "正史、编年史及现代通史相关纪事",
        "status": "已给公开入口，待逐条细核卷章",
        "plainText": "白话理解：北宋在熙河方向经营吐蕃诸部，试图绕击西夏、拓展西北战略空间，是王安石变法时期军事财政结合的代表。",
        "note": "不堆原文，先给学习者能读懂的解释；涉及争议细节时以主流史学概括为准。"
      }
    ],
    "causalChain": [],
    ...
    "reviewQuestions": [
      {
        "type": "主线理解",
        "question": "熙河开边与西北战略调整为什么应进入北宋主线？",
        "answer": "因为它改变了权力结构、制度运行、战争格局或社会经济秩序，能解释前后阶段如何衔接。"
      }
    ],
    "notes": [],
  ...
  {
    "id": "northern-song-yuanyou-counterreform",
    "dynastyId": "northern-song",
    "dynasty": "北宋",
    "title": "元祐更化与新旧党争制度化",
    "aliases": [],
    ...
    "summary": "神宗死后，高太后和司马光等废改新法，元祐更化使政策分歧转化为长期党争，影响北宋后期政治运行。",
    "bookmarked": false,
    "people": [
      {
        "name": "司马光",
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "司马光需要放在“元祐更化与新旧党争制度化”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "元祐更化与新旧党争制度化"
        ]
      },
      {
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "高太后需要放在“元祐更化与新旧党争制度化”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "元祐更化与新旧党争制度化"
        ]
      },
      {
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "宋哲宗需要放在“元祐更化与新旧党争制度化”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "元祐更化与新旧党争制度化"
        ]
      }
    ...
    "relations": [],
    "background": [
      "元祐更化与新旧党争制度化发生前，北宋的政治结构、财政动员、地方秩序或边疆关系已经积累压力；这一事件能解释前后阶段为何发生转向。"
    ],
    "process": [
      {
        "time": "1085-1093",
        "title": "神宗去世改变权力结构",
        "description": "哲宗年幼，高太后临朝，反对新法的旧党获得政治机会。变法从政策争论转入路线清算。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
      },
      {
        "time": "1085-1093",
        "title": "新法被大规模废改",
        "description": "司马光等废除青苗、免役等措施，恢复旧制。部分政策确有弊端，但快速反转也造成行政不稳定。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
      },
      {
        "time": "1085-1093",
        "title": "党争成为后期政治框架",
        "description": "元祐以后新旧党标签固化，后续绍圣、崇宁时期又反向清算。北宋后期很多决策失灵都要放在党争制度化中理解。"
      }
    ],
    "results": [
      "神宗死后，高太后和司马光等废改新法，元祐更化使政策分歧转化为长期党争，影响北宋后期政治运行。",
      "神宗死后，高太后和司马光等废改新法，元祐更化使政策分歧转化为长期党争，影响北宋后期政治运行。"
    ],
    "debates": [
      {
    ...
    "claims": [
      {
        "statement": "神宗死后，高太后和司马光等废改新法，元祐更化使政策分歧转化为长期党争，影响北宋后期政治运行。",
        "status": "较稳妥",
        "statusType": "stable",
        "confidence": "medium",
        "sourceIds": [
    ...
    "citations": [
      {
        ...
        "reference": "正史、编年史及现代通史相关纪事",
        "status": "已给公开入口，待逐条细核卷章",
        "plainText": "白话理解：神宗死后，高太后和司马光等废改新法，元祐更化使政策分歧转化为长期党争，影响北宋后期政治运行。",
        "note": "不堆原文，先给学习者能读懂的解释；涉及争议细节时以主流史学概括为准。"
      }
    ],
    "causalChain": [],
    ...
    "reviewQuestions": [
      {
        "type": "主线理解",
        "question": "元祐更化与新旧党争制度化为什么应进入北宋主线？",
        "answer": "因为它改变了权力结构、制度运行、战争格局或社会经济秩序，能解释前后阶段如何衔接。"
      }
    ],
    "notes": [],
  ...
  {
    "id": "northern-song-fangla-uprising",
    "dynastyId": "northern-song",
    "dynasty": "北宋",
    "title": "方腊起义与东南财政压力",
    "aliases": [],
    ...
    "summary": "方腊起义爆发于东南富庶地区，反映花石纲、赋役和地方压榨造成的社会压力，削弱北宋末年应对外患的能力。",
    "bookmarked": false,
    "people": [
      {
        "name": "方腊",
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "方腊需要放在“方腊起义与东南财政压力”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "方腊起义与东南财政压力"
        ]
      },
      {
        ...
        "years": "",
        "color": "var(--accent-gold)",
        "bio": "宋徽宗需要放在“方腊起义与东南财政压力”的制度、战争、财政或社会结构变化中理解，不应只当作孤立人物记忆。",
        "events": [
          "方腊起义与东南财政压力"
        ]
      }
    ...
    "relations": [],
    "background": [
      "方腊起义与东南财政压力发生前，北宋的政治结构、财政动员、地方秩序或边疆关系已经积累压力；这一事件能解释前后阶段为何发生转向。"
    ],
    "process": [
      {
        "time": "1120-1121",
        "title": "东南承担沉重供输",
        "description": "徽宗朝宫廷消费、花石纲和地方官吏搜括加重东南负担。富庶地区并不等于社会稳定，过度征敛会激化矛盾。"
      },
      {
        "time": "1120-1121",
        "title": "起义迅速扩展",
        "description": "方腊利用民间宗教和地方不满起兵，攻占多地，威胁杭州等东南重镇。北宋必须调动大量军力镇压。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
      },
      {
        "time": "1120-1121",
        "title": "内乱削弱抗金能力",
        "description": "起义虽被平定，却消耗财政和军事资源。它与海上之盟、金军南下共同构成北宋末年危局的一部分。 这一步会改变后续权力配置、区域格局或制度运行，所以需要放在主线中理解。"
      }
    ],
    "results": [
      "方腊起义爆发于东南富庶地区，反映花石纲、赋役和地方压榨造成的社会压力，削弱北宋末年应对外患的能力。",
      "方腊起义爆发于东南富庶地区，反映花石纲、赋役和地方压榨造成的社会压力，削弱北宋末年应对外患的能力。"
    ],
    "debates": [
      {
    ...
    "claims": [
      {
        "statement": "方腊起义爆发于东南富庶地区，反映花石纲、赋役和地方压榨造成的社会压力，削弱北宋末年应对外患的能力。",
        "status": "较稳妥",
        "statusType": "stable",
        "confidence": "medium",
        "sourceIds": [
    ...
    "citations": [
      {
        ...
        "reference": "正史、编年史及现代通史相关纪事",
        "status": "已给公开入口，待逐条细核卷章",
        "plainText": "白话理解：方腊起义爆发于东南富庶地区，反映花石纲、赋役和地方压榨造成的社会压力，削弱北宋末年应对外患的能力。",
        "note": "不堆原文，先给学习者能读懂的解释；涉及争议细节时以主流史学概括为准。"
      }
    ],
    "causalChain": [],
    ...
    "reviewQuestions": [
      {
        "type": "主线理解",
        "question": "方腊起义与东南财政压力为什么应进入北宋主线？",
        "answer": "因为它改变了权力结构、制度运行、战争格局或社会经济秩序，能解释前后阶段如何衔接。"
      }
    ],
    "notes": [],
