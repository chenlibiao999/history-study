window.AFRICA_HISTORY_PACKAGE = {
  ...
  moduleIds: ["africa-essential-empires", "ancient-egypt", "african-world", "african-civilizations", "nubia-kush"],
  topicIds: [],
  boundaries: [
  ...
  nextExpansionSlots: [
    ...
    { id: "east-african-coast", title: "东非海岸与印度洋贸易", status: "planned", suggestedMinEvents: 25 },
    { id: "african-world", title: "非洲文明与国家形成", status: "active", suggestedMinEvents: 22 },
    { id: "african-civilizations", title: "非洲文明与国家形成（扩展）", status: "active", suggestedMinEvents: 41 }
  ]
};
