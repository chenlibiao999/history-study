(() => {
  ...
  const regions = [window.EAST_ASIA_REGION, window.SOUTH_ASIA_REGION, window.SOUTHEAST_ASIA_REGION, window.EUROPE_REGION, window.AFRICA_REGION, window.WEST_ASIA_REGION, window.AFRO_EURASIA_CROSSROADS_REGION].filter(Boolean);
  const civilizationPackages = [window.CHINA_HISTORY_PACKAGE, window.JAPAN_HISTORY_PACKAGE, window.INDIAN_SUBCONTINENT_PACKAGE, window.SOUTHEAST_ASIA_PACKAGE, window.EUROPE_HISTORY_PACKAGE, window.AFRICA_HISTORY_PACKAGE, window.WEST_ASIA_HISTORY_PACKAGE, window.AFRO_EURASIA_CROSSROADS_PACKAGE].filter(Boolean);
