...
const longCycleThresholds = [
  ["shang", 30, "商朝超过五百年，需覆盖方国、都邑、礼制、军事与商周转折"],
  ["western-zhou", 35, "西周超过二百年，需覆盖封建、宗法礼制、王权衰落与东迁前因"],
  ["spring-autumn-warring-states", 45, "春秋战国跨度长且诸侯线复杂，需覆盖争霸、变法、合纵连横与秦统一前置"],
  ["western-han", 25, "西汉超过二百年，需覆盖郡国、财政、儒学、边疆与外戚前夜"],
  ["eastern-han", 35, "东汉近二百年，需覆盖统一、外戚宦官、羌乱、士人清议、黄巾与地方化"],
  ["northern-southern", 36, "五胡十六国南北朝近三百年且极复杂，后续应继续按多主线加密"],
  ["tang", 60, "唐朝近三百年，需覆盖统一、贞观、武周、开天转折、安史、藩镇、财政与唐末"],
  ["liao", 20, "辽超过二百年，需覆盖契丹建国、南北面官、燕云、澶渊、女真兴起与灭亡"],
  ["western-xia", 20, "西夏近二百年，需覆盖党项建国、宋夏战争、文字制度、河西经营与蒙夏战争"],
  ["jin", 20, "金超过百年，需覆盖女真兴起、灭辽灭北宋、汉地治理、迁都与蒙金战争"],
  ["northern-song", 26, "北宋超过百年，需覆盖建国集权、宋辽宋夏、财政变法、党争与靖康危机"],
  ["southern-song", 26, "南宋超过百年，需覆盖南渡、宋金和战、权臣政治、宋蒙战争与亡国"],
  ["yuan", 25, "元朝按蒙古-元连续帝国理解超过百年，需覆盖建元、统一、行省、多民族治理与元末"],
  ["ming", 29, "明朝近三百年，需覆盖建国、靖难、海洋、财政、党争、辽东、民变与明清转折"],
  ["qing", 31, "清朝近三百年，需覆盖入关、统一、边疆、盛世、财政、外患与近代转型"],
