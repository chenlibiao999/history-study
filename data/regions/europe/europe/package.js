window.EUROPE_HISTORY_PACKAGE = {
  ...
  moduleIds: ["ancient-greece", "roman-world", "roman-republic", "roman-empire", "byzantium", "medieval-western-europe", "russian-eastern-europe", "ottoman-world", "modern-europe"],
  topicIds: [],
  boundaries: [
  ...
  nextExpansionSlots: [
    ...
    { id: "roman-world", title: "罗马世界", status: "active", suggestedMinEvents: 25 },
    { id: "roman-republic", title: "罗马共和国", status: "planned", suggestedMinEvents: 30 },
    { id: "roman-empire", title: "罗马帝国", status: "planned", suggestedMinEvents: 35 },
    { id: "byzantium", title: "拜占庭帝国", status: "planned", suggestedMinEvents: 25 },
    { id: "medieval-western-europe", title: "中世纪西欧", status: "active", suggestedMinEvents: 35 },
    { id: "russian-eastern-europe", title: "俄罗斯与东欧", status: "active", suggestedMinEvents: 16 },
    { id: "ottoman-world", title: "奥斯曼世界", status: "active", suggestedMinEvents: 13 },
    { id: "modern-europe", title: "近现代欧洲", status: "active", suggestedMinEvents: 16 },
    { id: "renaissance-reformation", title: "文艺复兴与宗教改革", status: "planned", suggestedMinEvents: 25 },
